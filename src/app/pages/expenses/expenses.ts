...
export class Expenses {
  ...
  get expenseCategories() {
    return this.svc.categories().filter(c => c.type === 'expense' || c.type === 'both');
  }
  ...
  save(): void {
    ...
    if (id) {
      this.svc.updateTransaction({ ...this.form, id, type: 'expense' });
    } else {
      this.svc.addTransaction({ ...this.form, type: 'expense' });
    }
  ...
  openCategoryModal(): void {
    this.newCategory = { name: '', incomeEnabled: false, expenseEnabled: true };
